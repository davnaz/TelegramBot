...
namespace TelegramBot.DataProviders
{
    public class DataProvider : SingleTone<DataProvider>
    {
        ...
        {
            SqlCommand command = new SqlCommand("Insert procedure", new SqlConnection(Resources.DbConnectionString));
        ...
        #endregion
        internal DataRow GetDataRowFromDb(string query)
        {
